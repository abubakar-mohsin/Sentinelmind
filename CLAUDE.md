# CLAUDE.md — SentinelMind Build Guide

> This is the entry-point file for Claude Code. Read this first, then read the
...
effort over ~15 days using Claude Code. Scope accordingly — the tables above are
